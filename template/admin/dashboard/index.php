...
?>
    <div class="row mt-3">
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="http://localhost/restaurant/category" class="text-decoration-none">
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="http://localhost/restaurant/users" class="text-decoration-none">
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="http://localhost/restaurant/article" class="text-decoration-none">
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="http://localhost/restaurant/comment" class="text-decoration-none">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <?php foreach($lastComments as $comment) {?>
                        ...
                        <tr>
                            <td><a class="text-primary" href="http://localhost/restaurant/comment/show/<?php echo  $comment['id'] ?>"><?php echo  $comment['id'] ?></a></td>
