                ...
                <section class="col-12">
                    <form method="post" action="http://localhost/restaurant/branch/store">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="location" name="location" placeholder="Enter name ...">
                        </div>

                        <div class="form-group">
                            <label for="location">telephone</label>
                            <input type="text" class="form-control" id="telephone" name="telephone" placeholder="Enter name ...">
                        </div>
