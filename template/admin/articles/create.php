...
<section class="row my-3">
    <section class="col-12">
        ...
        <form method="post" action="http://localhost/restaurant/article/store" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="materiales" name="materiales" placeholder="materiales ..." rows="3" required autofocus></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="price" name="price" placeholder="price ..." rows="5" required autofocus></textarea>
            </div>
